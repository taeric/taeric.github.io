...
* Introduction
  ...
  If you have never heard of it, [[http://www-cs-faculty.stanford.edu/~uno/papers/dancing-color.ps.gz][Dancing Links]] is a technique that
  Knuth introduced to implement a recursive backtracking algorithm.
  If you truly want a good treatment as to what the technique is, I
  can not recommend going straight to the source heavily enough.
...
* N-Queens
  ...
  First a brief exploration of the dancing links in solving a
...
** Dancing Links
   ...
   tangled into a single file, peek over at [[dancingLinks.js]].
